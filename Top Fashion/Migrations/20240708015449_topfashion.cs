...
{
    /// <inheritdoc />
    public partial class topfashion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "1", "Category_one", 1 },
                    { 2, "2", "Category_two", 1 },
                    { 3, "3", "Category_three", 1 }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Description", "Name", "Price", "ProductPicture", "Vat" },
                values: new object[,]
                {
                    { 1, 1, "1", "Product_one", 2000m, "https://", 10m },
                    { 2, 1, "2", "Product_two", 2000m, "https://", 20m },
                    { 3, 1, "3", "Product_three", 2000m, "https://", 30m }
                });
